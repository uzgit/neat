...
population = Population(num_inputs=2, num_outputs=1, population_size=150, num_initial_mutations=1, output_stream=sys.stdout)
champion = population.run(evaluation_function=test_xor_sigmoid, num_generations=100)
